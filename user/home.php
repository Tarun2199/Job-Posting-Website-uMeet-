...
<body class="animsition">
    <div class="page-wrapper">
                            ...
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <button class="au-btn au-btn-icon au-btn--blue">
                                        <i class="zmdi zmdi-plus"></i><a href="add_job_details.php" style="color:#fff;"> Add Job</a></button>
                                </div>
                            </div>
                        </div>
                        <?php 
          include('../db-connect.php');
          $query = "select * from `job` order by id limit 5";
          $run  = mysqli_query($conn,$query);
          $num_row=mysqli_num_rows($run);
          $query1 = "select * from `job`";
          $run1  = mysqli_query($conn,$query1);
          $num_row1=mysqli_num_rows($run1);
          ?>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <h2 class="title-1 m-b-25">Latest Job</h2>
      ...
      ?>
                            ...
                            <div class="col-lg-3">
                                <h2 class="title-1 m-b-25">Top Sector</h2>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-top-countries">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Construction & Property</td>
                                                        <td class="text-right">10</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Oil, Gas, Power & Energy</td>
