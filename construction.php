       ...
       <?php 
          ...
          if(isset($_GET['location'],$_GET['fsalary']))
            {  
               ...
               $salary=$_GET['fsalary'];
               $query = "select * from `job` where sector='Construction & Property' and `location`='$location' and (salary<='$salary')";
            }
         elseif(isset($_GET['location']))
            {
               $location=$_GET['location'];
               $query = "select * from `job` where sector='Construction & Property' and `location`='$location'";
            }
         elseif(isset($_GET['fsalary']))
            {
               $salary=$_GET['fsalary'];
               $query = "select * from `job` where sector='Construction & Property' and `salary`<='$salary'";
            }
         else
         {  
            $query = "select * from `job` where sector='Construction & Property'";
         }
               ...
               <div class="jsrp_base">
                  <div class="searchhead">
                     <div class="tophead">
                        <div class="jsrpCount">
                           <div class="num_key">
                              <h1>Construction & Property Jobs</h1>
                           </div>
                        </div>
                        <div class="keywords"><em><strong>Industry:</strong>Construction & Property</em>
                        </div>
                     </div>
                  </div>
