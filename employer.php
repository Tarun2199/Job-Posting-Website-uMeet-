...
<li><a href="#">Get Ticket</a></li>
       ...
       <?php 
          ...
          if(isset($_GET['location'],$_GET['fsalary'],$_GET['sector']))
            {  
               $location=$_GET['location'];
               $salary=$_GET['fsalary'];
               $sector=$_GET['sector'];
               $query = "select * from `job` where `sector`='$sector' `location`='$location' and (salary<='$salary')";
            }
         ...
         elseif(isset($_GET['fsalary']))
            {
               $salary=$_GET['fsalary'];
               $query = "select * from `job` where `salary`<='$salary'";
            }
         else
         {  
               ...
               <div class="jsrp_base">
                  <div class="searchhead">
                     <div class="tophead">
                        ...
                        <div class="keywords"><em><strong>Industry:</strong>All</em>
                        </div>
                     </div>
                  </div>
                     ...
                     <form action="employer.php" method="get">
                        <div id="id_floater" class="floatleft">
                           <ul class="filters" id="id_filters">
                              ...
                              <li class="cls_filter_p" id="id_filter_salary">
                                 Sector<i class="cls_filter_count"></i>
                                 <div class="submenu">
                                    <span class="arrowup"></span>
                                    <ul class="cls_filter_jFSal">
                                       <li title="up to 2 Lakh"><input aria-label="up to 2 Lakh" type="checkbox" name="sector" class="check1_new floatleft cls_facets_checkbox" value="Information Technology"><em>Information Technology</em></li>
                                       <li title="3 To 5 Lakh"><input aria-label="3 To 5 Lakh" type="checkbox" name="sector" class="check1_new floatleft cls_facets_checkbox" value="Manufacturing"><em>Manufacturing</em></li>
                                       <li title="6 To 8 Lakh"><input aria-label="6 To 8 Lakh" type="checkbox" name="sector" class="check1_new floatleft cls_facets_checkbox" value="Pharma, healthcare & lifesciences"><em>Pharma, healthcare & lifesciences</em></li>
                                       <li title="9 To 12 Lakh"><input aria-label="9 To 12 Lakh" type="checkbox" name="sector" class="check1_new floatleft cls_facets_checkbox" value="Banking & finance"><em>Banking & finance</em></li>
                                       <li title="9 To 12 Lakh"><input aria-label="9 To 12 Lakh" type="checkbox" name="sector" class="check1_new floatleft cls_facets_checkbox" value="Construction & Property"><em>Construction & Property</em></li>
                                       <li title="9 To 12 Lakh"><input aria-label="9 To 12 Lakh" type="checkbox" name="sector" class="check1_new floatleft cls_facets_checkbox" value="Oil, Gas, Power & Energy"><em>Oil, Gas, Power & Energy</em></li>
                                    </ul>
                                 </div>
                              </li>
