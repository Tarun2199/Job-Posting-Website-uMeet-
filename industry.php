       ...
       <?php 
          ...
          if(isset($_GET['location'],$_GET['fsalary']))
            {  
               ...
               $salary=$_GET['fsalary'];
               $query = "select * from `job` where sector='Information Technology' and `location`='$location' and (salary<='$salary')";
            }
         elseif(isset($_GET['location']))
            {
               $location=$_GET['location'];
               $query = "select * from `job` where sector='Information Technology' and `location`='$location'";
            }
         elseif(isset($_GET['fsalary']))
            {
               $salary=$_GET['fsalary'];
               $query = "select * from `job` where sector='Information Technology' and `salary`<='$salary'";
            }
         else
         {  
            $query = "select * from `job` where sector='Information Technology'";
         }
               ...
               <div class="jsrp_base">
                  <div class="searchhead">
                     <div class="tophead">
                        <div class="jsrpCount">
                           <div class="num_key">
                              <h1>It - Software Industry Jobs</h1>
                           </div>
                        </div>
                        <div class="keywords"><em><strong>Industry:</strong>IT - Software</em>
                        </div>
                     </div>
                  </div>
