       ...
       <?php 
          ...
          if(isset($_GET['location'],$_GET['fsalary']))
            {  
               ...
               $salary=$_GET['fsalary'];
               $query = "select * from `job` where sector='Banking & finance' and `location`='$location' and (salary<='$salary')";
            }
         elseif(isset($_GET['location']))
            {
               $location=$_GET['location'];
               $query = "select * from `job` where sector='Banking & finance' and `location`='$location'";
            }
         elseif(isset($_GET['fsalary']))
            {
               $salary=$_GET['fsalary'];
               $query = "select * from `job` where sector='Banking & finance' and `salary`<='$salary'";
            }
         else
         {  
            $query = "select * from `job` where sector='Banking & finance'";
         }
               ...
               <div class="jsrp_base">
                  <div class="searchhead">
                     <div class="tophead">
                        <div class="jsrpCount">
                           <div class="num_key">
                              <h1>Banking & finance Jobs</h1>
                           </div>
                        </div>
                        <div class="keywords"><em><strong>Industry:</strong>Banking & finance</em>
                        </div>
                     </div>
                  </div>
                        ...
                        <li class="search_listing cls_jobsnippet">
                           <ul>
                              ...
                              <li class="search_listingleft search_listingleft_100">
                                 <!-- <a rel="nofollow" class="cmplogo" target="_blank" href="" data-cid="710243"><img alt="logo" src="https://static2.shine.com/r/m/images/employerbranding/ab28c36aa45e4f31983a0ca0c689c62b.jpg"></a> -->
