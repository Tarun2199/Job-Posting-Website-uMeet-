       ...
       <?php 
          ...
          if(isset($_GET['location'],$_GET['fsalary']))
            {  
               ...
               $salary=$_GET['fsalary'];
               $query = "select * from `job` where sector='Digital, Marketing & Communication' and `location`='$location' and (salary<='$salary')";
            }
         elseif(isset($_GET['location']))
            {
               $location=$_GET['location'];
               $query = "select * from `job` where sector='Digital, Marketing & Communication' and `location`='$location'";
            }
         elseif(isset($_GET['fsalary']))
            {
               $salary=$_GET['fsalary'];
               $query = "select * from `job` where sector='Digital, Marketing & Communication' and `salary`<='$salary'";
            }
         else
         {  
            $query = "select * from `job` where sector='Digital, Marketing & Communication'";
         }
               ...
               <div class="jsrp_base">
                  <div class="searchhead">
                     <div class="tophead">
                        ...
                        <div class="keywords"><em><strong>Industry:</strong>Digital, Marketing & Communication</em>
                        </div>
                     </div>
                  </div>
